...
# CodeProt
set(ALL_CODEPROT_SUPPORTED_ARCH ${X86} ${X86_64})
...
if(APPLE)
  ...
  list_intersect(CFI_SUPPORTED_ARCH
    ...
    SANITIZER_COMMON_SUPPORTED_ARCH)
  # CodeProt
  list_intersect(CODEPROT_SUPPORTED_ARCH
    ALL_CODEPROT_SUPPORTED_ARCH
    SANITIZER_COMMON_SUPPORTED_ARCH)
  ...
  # CodeProt
  filter_available_targets(CODEPROT_SUPPORTED_ARCH ${ALL_CODEPROT_SUPPORTED_ARCH})
...
# CodeProt
if (COMPILER_RT_HAS_SANITIZER_COMMON AND CODEPROT_SUPPORTED_ARCH)
  set(COMPILER_RT_HAS_CODEPROT TRUE)
else()
  set(COMPILER_RT_HAS_CODEPROT FALSE)
endif()

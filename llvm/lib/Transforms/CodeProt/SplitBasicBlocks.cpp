...
namespace {
struct SplitBasicBlock : public ModulePass {
  static char ID; // Pass identification, replacement for typeid
  bool flag;

  SplitBasicBlock() : ModulePass(ID) {}
  SplitBasicBlock(bool flag) : ModulePass(ID) {
...
bool SplitBasicBlock::runOnModule(Module &M) {
  LLVM_DEBUG(outs() << "Split debug!\n");
